...
export default function Home() {
  ...
  const [validatedInputs, setValidatedInputs] = useState<Record<string, Record<string, string>>>({});
  ...
  const handleValidation = useCallback((file: string, key: string, value: string) => {
